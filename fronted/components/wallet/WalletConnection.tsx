import { DisplayValue, LabelValueGrid } from "../ui/LabelValueGrid";
            ...
            items={[
              {
                ...
                value: (
                  <DisplayValue
                    value={account?.address ? account.address.toString() : "Not Present"}
              ...
              },
              {
                ...
                value: (
                  <p>{account?.address?.toString() ?? "Not Present"}</p>
                ),
              },
            ]}
          />
